...
class Renderer {
    ...
    */
    constructor(gl, scene, camera) {
        ...
        this.gl.clearColor(this.scene.fogColor[0], this.scene.fogColor[1], this.scene.fogColor[2], 1.0);
    ...
    render() {
        ...
        for (var i = 0; i < this.scene.geometries.length; i++) {
            ...
            geometry.shader.setUniform("u_FogDist", this.scene.fogDist);
            geometry.shader.setUniform("u_FogColor", this.scene.fogColor);
